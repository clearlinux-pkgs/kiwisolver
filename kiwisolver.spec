...
Requires: kiwisolver-license = %{version}-%{release}
...
%package license
Summary: license components for the kiwisolver package.
Group: Default

%description license
license components for the kiwisolver package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636477025
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/kiwisolver
cp %{_builddir}/kiwisolver-1.3.2/LICENSE %{buildroot}/usr/share/package-licenses/kiwisolver/ace4126f107c97f428124e67a02779b336f58099
...
/usr/share/package-licenses/kiwisolver/ace4126f107c97f428124e67a02779b336f58099
